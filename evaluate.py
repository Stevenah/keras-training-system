...
def evaluate(model, config, validation_directory, experiment):
    ...
    # get file names
    results_file_name = config['summary_files']['split_evaluation_summary']
    missclassification_file_name = config['summary_files']['missclassification_summary']
